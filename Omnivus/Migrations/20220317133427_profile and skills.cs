...
{
    public partial class profileandskills : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProfile_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserProfile", x => new { x.UserId, x.ProfileId });
                    table.ForeignKey(
                        name: "FK_AppUserProfile_AppProfile_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "AppProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserProfile_IdentityUser_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfile_ProfileId",
